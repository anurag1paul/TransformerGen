...
from attnGan.networks import CA_NET
...
class Self_Attn(nn.Module):
    ...
    def __init__(self, in_channels, opts, device):
...
class GenBlock(nn.Module):
    def __init__(self, ngf, ncf, num_classes, opts, device):
        ...
        self.ngf = ngf
        self.in_dim = opts.GAN.Z_DIM + ncf
    ...
    def forward(self, z_code, sent_emb, labels):
        x0 = z_code
